export default {
  ...
  DOCS_URL: '//www.emovur.com/docs/product/',
  HELP_CENTER_DOCS_URL: '//www.emovur.com/docs/product/others/help-center',
  TESTIMONIAL_URL: 'https://testimonials.cdn.emovur.com/content.json',
