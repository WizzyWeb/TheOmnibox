...
describe('#MessageFormatter', () => {
  describe('content with links', () => {
    it('should format correctly', () => {
      const message =
        'Emovur Chat is an opensource tool. [Emovur Chat](https://chatapp.emovur.com)';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Emovur Chat is an opensource tool. <a href="https://chatapp.emovur.com" class="link" rel="noreferrer noopener nofollow" target="_blank"> Emovur Chat </a></p>'
      );
    });
    it('should format correctly', () => {
      const message =
        'Emovur Chat is an opensource tool. https://chatapp.emovur.com';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Emovur Chat is an opensource tool. <a href="https://chatapp.emovur.com" class="link" rel="noreferrer noopener nofollow" target="_blank">https://chatapp.emovur.com</a></p>'
      );
    });
  });
...
<h2>tool</h2>`
  ...
  describe('content with image and has "cw_image_height" query at the end of URL', () => {
    it('should set image height correctly', () => {
      const message =
        'Emovur is an opensource tool. ![](http://chatwoot.com/chatwoot.png?cw_image_height=24px)';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Emovur Chat is an opensource tool. <img src="http://chatwoot.com/chatwoot.png?cw_image_height=24px" alt="" style="height: 24px;" /></p>'
      );
    });

    it('should set image height correctly if its original size', () => {
      const message =
        'Emovur is an opensource tool. ![](http://chatwoot.com/chatwoot.png?cw_image_height=auto)';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Emovur Chat is an opensource tool. <img src="http://chatwoot.com/chatwoot.png?cw_image_height=auto" alt="" style="height: auto;" /></p>'
      );
    });

    it('should not set height', () => {
      const message =
        'Emovur is an opensource tool. ![](http://chatwoot.com/chatwoot.png)';
      expect(new MessageFormatter(message).formattedMessage).toMatch(
        '<p>Emovur Chat is an opensource tool. <img src="http://chatwoot.com/chatwoot.png" alt="" /></p>'
      );
    });
  });
  ...
  describe('tweets', () => {
    it('should return the same string if not tags or @mentions', () => {
      const message = 'Emovur is an opensource tool';
  ...
  describe('plain text content', () => {
    it('returns the plain text without HTML', () => {
      const message =
        '<b>Emovur is an opensource tool. https://chatapp.emovur.com</b>';
      expect(new MessageFormatter(message).plainText).toMatch(
        'Emovur is an opensource tool. https://chatapp.emovur.com'
      );
    });
  });
