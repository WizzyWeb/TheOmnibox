...
CHATWOOT_HUB_URL="https://hub.2.theomnibox.com/events"
...
Join the community at https://theomnibox.com/community?utm_source=cwctl
***************************************************************************
...
function get_cw_version() {
  CW_VERSION=$(curl -s https://app.theomnibox.com/api | python3 -c 'import sys,json;data=json.loads(sys.stdin.read()); print(data["version"])')
}
...
https://www.theomnibox.com/docs/deployment/deploy-chatwoot-in-linux-vm?utm_source=cwctl
...
Get help, https://theomnibox.com/community?utm_source=cwctl
