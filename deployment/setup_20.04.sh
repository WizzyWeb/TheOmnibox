...
CHATWOOT_HUB_URL="https://hub.2.emovur.com/events"
...
Join the community at https://emovur.com/community?utm_source=cwctl
***************************************************************************
...
function get_cw_version() {
  CW_VERSION=$(curl -s https://app.emovur.com/api | python3 -c 'import sys,json;data=json.loads(sys.stdin.read()); print(data["version"])')
}
...
https://www.emovur.com/docs/deployment/deploy-chatwoot-in-linux-vm?utm_source=cwctl
...
Get help, https://emovur.com/community?utm_source=cwctl
